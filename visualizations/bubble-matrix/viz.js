...
(function() {
    ...
    const BUBBLE_MATRIX_SETTINGS = {
        // Sempre usa formato panorâmico - dimensões fixas
        fixedWidth: 1000,
        fixedHeight: 600,
        
        margins: {
            top: 80,   // Espaço para headers das colunas
            right: 60,
            bottom: 60,
    ...
    function calculateLayout(config, structure, dataLength) {
        ...
        const matrixAreaHeight = availableHeight - titleHeight - sourceHeight;
        ...
        const matrixY = margins.top + titleHeight + (matrixAreaHeight - matrixHeight) / 2;
        ...
        return {
            ...
            headers: {
                y: matrixY - spacing.headerOffset,
